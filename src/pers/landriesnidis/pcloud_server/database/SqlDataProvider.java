...
public class SqlDataProvider {
	 ...
	 * @throws SQLException
	 */
	public static JSONObject UserLogin(final String account, final String password) throws SQLException{
		DBAction action = new DBAction();
		List<HashMap<String,Object>> lm = action.exeQuery("Call UserLogin(?,?);",new DBAction.ParameterSetter() {
			@Override
		...
		try {
			json.put("token", (String) lm.get(0).get("token"));
			json.put("rootfolder", (String) lm.get(0).get("rootfolder"));
